...
import com.assignment.googlemapsuniversities.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var uniMap: UniMap
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        uniMap=intent.getSerializableExtra("Uni_name") as UniMap
